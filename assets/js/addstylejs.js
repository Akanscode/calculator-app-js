const bodyClass =
  "bg-purple-800 bg-gradient-to-br from-blue-300 bg-opacity-25 flex justify-center items-center my-40";
const bdy = document.querySelector("body");
bodyClass.split(" ").forEach((cls) => bdy.classList.add(cls));
// styling the calculatoor body
const calcBodyClass =
  "max-w-lg overflow-hidden shadow-2xl bg-pink-700 bg-opacity-75 bg-gradient-to-tr from-gray-800 flex";
const calcBody = document.querySelector(".calcBody");
calcBodyClass.split(" ").forEach((cls) => calcBody.classList.add(cls));
// addind style to the output
const outputClass =
...
// addding style to the previous number
...
// styling the curreent number that hold value to calculate
...
// styling the buttion for operation
...
function addClasses(button) {
  const btnNumberClass = "hover:bg-orange-500 border-green-500";
  const btnClearClass = "hover:bg-orange-500 border-green-500";
  const btnOpClass = "hover:bg-orange-500 border-green-500";
  const btnEqClass = "hover:bg-orange-500 border-green-500";
  const btnDecClass = "hover:bg-orange-500 border-green-500";
  ...
  const baseClass =
    "number flex w-12 h-12 justify-center m-1 font-bold py-2 px-2 bprder hover:border-transparent rounded text-white border-2 text-2xl";
